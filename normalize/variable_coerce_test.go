...
func TestCoerceVariablePlaceholders(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "input object empty string becomes empty map", types: VariableTypeMap{"var1": "V1AccountFilter!"}, vars: VariableMap{"var1": ""}, key: "var1", checkType: "map"},
		{name: "input object nullable becomes nil", types: VariableTypeMap{"var1": "V1AccountFilter"}, vars: VariableMap{"var1": ""}, key: "var1", checkType: "nil"},
		{name: "list type becomes empty slice", types: VariableTypeMap{"var1": "[String!]!"}, vars: VariableMap{"var1": ""}, key: "var1", checkType: "slice"},
		{name: "string type stays empty string", types: VariableTypeMap{"var1": "String!"}, vars: VariableMap{"var1": ""}, key: "var1", wantValue: "", checkType: "equal"},
		{name: "missing type leaves value", types: VariableTypeMap{}, vars: VariableMap{"var1": "keep"}, key: "var1", wantValue: "keep", checkType: "equal"},
		{name: "present value untouched", types: VariableTypeMap{"var1": "V1AccountFilter!"}, vars: VariableMap{"var1": "value"}, key: "var1", wantValue: "value", checkType: "equal"},
		{name: "nil builtin scalar stays nil", types: VariableTypeMap{"var1": "String!"}, vars: VariableMap{"var1": nil}, key: "var1", checkType: "nil"},
		{name: "nil list becomes empty slice", types: VariableTypeMap{"var1": "[String!]!"}, vars: VariableMap{"var1": nil}, key: "var1", checkType: "slice"},
		{name: "nil input object nullable stays nil", types: VariableTypeMap{"var1": "V1AccountFilter"}, vars: VariableMap{"var1": nil}, key: "var1", checkType: "nil"},
		{name: "nil input type with bang becomes map", types: VariableTypeMap{"var1": "AccountInput!"}, vars: VariableMap{"var1": nil}, key: "var1", checkType: "map"},
	}
